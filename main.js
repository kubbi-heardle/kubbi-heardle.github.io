...
//   EDIT THINGS HERE
  ...
  const HEARDLE_GITHUB_NAME = "kubbi-heardle"; // put your github username here
  
  const HEARDLE_URL = "https://"+HEARDLE_GITHUB_NAME+".github.io/";
  
  const HEARDLE_ARTIST = "Kubbi";
  
  const HEARDLE_NAME = HEARDLE_ARTIST + "Heardle";
  
  const HEARDLE_START_DATE = "2025-07-17";
  
  // make sure you have 7 comments here
  const HEARDLE_GAME_COMMENTS = [
      "Womp womp!", // FAILED
      "You need help!", // First try
      "You're quick!",
      "Good job!",
      "Took a second!",
      "Was getting worried!",
      "Just got it!" // Sixth try
    ]; 
  const HEARDLE_GOOGLE_ANALYTICS = "no";
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> for '+HEARDLE_ARTIST+' songs.</p><p class="mb-3">Each '+HEARDLE_ARTIST+' Heardle is randomly chosen from '+HEARDLE_ARTIST+'\'s discography on Soundcloud</p> \n\n<p class="mb-3">Remixed and extended by <a href="https://twitter.com/derekahmedzai">@derekahmedzai</a>. All copyright goes to the respective artists, companies, and other relevant parties.</p> \n\n\n\n <p class="mb-3"></p> \n\n<p class="mb-3">Also check out the <a href="https://heardle.orchards.dev/">underscores</a>, <a href="https://red-velvet-heardle.glitch.me/">Red Velvet</a>, <a href="https://kpopgg-heardle-round2.glitch.me/">K-Pop Girl Group</a>, <a href="https://shonen-knife-heardle.glitch.me/">Shonen Knife</a> and the <a href="https://depth-charge-heardle.glitch.me/">Depth Charge</a> Heardles</p> \n\n\n\n <p class="mb-3"><a href="https://github.com/'+HEARDLE_GITHUB_NAME+'/'+HEARDLE_GITHUB_NAME+'.github.io/fork">Make your own Heardle by remixing this one</a></p> \n\n\n\n <p class="mb-3"></p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Songs from <a href="https://soundcloud.com">Soundcloud</a>\n and powered by <a href="https://github.com/">GitHub</a>. See the source code <a href="https://github.com/'+HEARDLE_GITHUB_NAME+'/'+HEARDLE_GITHUB_NAME+'.github.io">here</a>.'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
    ...
    return {
      c() {
        (n = w("div")),
          (r = w("a")),
          (r.innerHTML =
            '<span class="kofitext svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="DINNER donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Support me on Ko-Fi</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
          M(
            r,
            "class",
            "kofi-button py-2 px-3 rounded-lg items-center flex  svelte-1d3p4dy"
          ),
          M(r, "href", "https://www.fitnessgrampacertest.com/"),
          M(r, "title", "Support me on DINNER"),
          M(
            n,
            "class",
